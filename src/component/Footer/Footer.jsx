                    ...
                    <div>
                        ...
                        <form className="space-y-3">
                            ...
                            <textarea placeholder="Your message" rows="3"
                                className="w-full px-4 py-2 bg-gray-900 border border-gray-600 text-white placeholder-gray-400 rounded-md"></textarea>
                            <button type="submit"
                                className="bg-gray-700 hover:bg-green-600 w-full px-6 py-2 rounded-md font-semibold">SEND</button>
                        </form>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            ...
                            <div className="w-full h-20 bg-gray-700 rounded-md overflow-hidden">
                                <img src={ProjectImage} alt="Latest Project Thumbnail"
